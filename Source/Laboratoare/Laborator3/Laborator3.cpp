...
void Laborator3::Update(float deltaTimeSeconds)
{
	...
	modelMatrix = glm::mat3(1);
	modelMatrix *= Transform2D::Translate(450 + cornerX, 300 + cornerY);

	rad += deltaTimeSeconds * 80;
	modelMatrix *= Transform2D::Rotate(rad);

	modelMatrix *= Transform2D::Translate(0 - cornerX, 0 - cornerY);
	...
	modelMatrix *= Transform2D::Translate(cornerX, cornerY);
	modelMatrix *= Transform2D::Scale(scaleX, scaleY);
	scaleX += deltaTimeSeconds * sc;
	scaleY += deltaTimeSeconds * sc;
